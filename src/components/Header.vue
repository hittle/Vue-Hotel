  ...
  <el-header>
    <div class="header">
      <div class="header-left">
        <img src="../assets/images/龙泉.png" alt="logo">
      ...
      <div class="header-right">
        ...
        <div class="admin-logo">
          <img :src="userPhoto" alt="adminLogo">
        </div>
      </div>
    </div>
  </el-header>
...
export default {
  data(){
    return {
      ...
      asideStatus:false,
      account:'lzl',
      userPhoto:'/static/img/login-left.09459b3.jpg'
    }
  },
  mounted(){
  ...
  methods:{
    getAccount(){
      this.getRequest('/getCurrentUser').then((res) =>{
        if(res.code === 200){
          console.log(res)
          this.account = res.data.account;
          // this.userPhoto = res.date.photo;
        }
      }).catch(err =>{
        this.$message({
        showClose:true,
